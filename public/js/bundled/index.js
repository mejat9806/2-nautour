...
if (document.querySelector(".form")) document.querySelector(".form")?.addEventListener("submit", (e)=>{
    e.preventDefault();
...
},{"./login":"aUJqG","./mapBox":"jAWzH","regenerator-runtime/runtime":"cDAES"}],"aUJqG":[function(require,module,exports) {
...
const logout = async ()=>{
    try {
        const res = await (0, _axiosDefault.default).post({
            method: "GET",
            url: "http://127.0.0.1:3000/api/v1/users/logout"
        });
        if (res.data.status === "success") location.reload(true); //this force the reload from the server on the client
    } catch (error) {
        error.response;
        (0, _alert.showAlert)("error", "please logout again");
    }
};
...
const showAlert = (type, msg)=>{
    ...
    window.setTimeout(removeAlerts, 5000);
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"fofuL"}],"jAWzH":[function(require,module,exports) {
